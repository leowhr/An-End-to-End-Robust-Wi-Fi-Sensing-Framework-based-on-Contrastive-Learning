...
def fine_tuning():
    ...
    log_dir_path = "./runs/REG/Scratch/scratch_reg_60_Biblockv2" #日志

    ## 加载的数据
    # old_Tune_final_weight_path = "./model_weight/wimamba_U1_4_2_final_100_tune100_finetuning.pth" # 上次训练最后的模型

    old_Tune_checkpoint_path = "./model_weight/REG/Scratch/scratch_reg_60_Biblockv2.pth" # 上次训练某一轮保存的微调权重和优化器状态
    ...
    new_Tune_checkpoint_path = "./model_weight/REG/Scratch/scratch_reg_60_Biblockv2.pth" # 每一轮保存的微调权重和优化器状态
