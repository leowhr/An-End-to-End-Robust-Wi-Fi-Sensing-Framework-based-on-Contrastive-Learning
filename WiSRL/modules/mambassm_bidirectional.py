...
class Mamba_bidirectional(nn.Module):
    def __init__(
        self,
        d_model,
        d_state=16,
...
class Block_Bidirectional(nn.Module):
    def __init__(
        self, dim,bimamba_type, norm_cls=nn.LayerNorm, fused_add_norm=False, residual_in_fp32=False
    ):
        """
        ...
        self.mixer = Mamba_bidirectional(d_model=dim,bimamba_type=bimamba_type)
