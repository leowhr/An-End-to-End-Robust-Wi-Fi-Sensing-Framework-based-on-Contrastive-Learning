...
from models.frozentune_model_simCLR import WiSRL_tune
...
def fine_tuning():
    ...
    log_dir_path = "./runs/Frozen/CLS/tune_100_100_Biblockv2_3+3link_test" #日志

    ## 加载的数据

    old_Tune_checkpoint_path = "./model_weight/Frozen/CLS/tune_100_100_Biblockv2_3+3link_test.pth" # 上次训练某一轮保存的微调权重和优化器状态

    ## 保存的数据
    new_Tune_checkpoint_path = "./model_weight/Frozen/CLS/tune_100_100_Biblockv2_3+3link_test.pth" # 每一轮保存的微调权重和优化器状态
    ...
    # 定义调度器 scheduler，保证学习率，与finetune有所不同，取消warm-up
